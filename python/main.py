...
for g in tmp_bars:
    ...
    for c in g:
        gr.append(
            RotatedAverageAudioBar(circleX+radius*math.cos(math.radians(ang - 90)), circleY+radius*math.sin(math.radians(ang - 90)), c, (255, 0, 255), angle=ang, width=8, max_height=270))
        ang += angle_dt
...
while running:
    ...
    # http://www.pygame-doku.laymaxx.de/ref/draw.html
    # https://www.pygame.org/docs/ref/draw.html
    # https://pygame.readthedocs.io/en/latest/2_draw/draw.html
    # https://pygame.readthedocs.io/en/latest/3_image/image.html#load-an-image
    # https://www.pygame.org/docs/ref/draw.html#pygame.draw.aalines

    pygame.draw.circle(screen, (130,230,230), [circleX, circleY], 80, 5)
    pygame.draw.circle(screen, (30,230,230), [circleX, circleY], 200, 5)
    #pygame.draw.line(screen, (30,230,230), (15, 140), (0, 25), 2) 

    # add text
    # https://stackoverflow.com/questions/20842801/how-to-display-text-in-pygame
    pygame.font.init()                 
    myfont = pygame.font.SysFont('Comic Sans MS', 62)
    textsurface = myfont.render('MPXVM', True, (20, 240, 240))
    screen.blit(textsurface,(circleX,circleY))
