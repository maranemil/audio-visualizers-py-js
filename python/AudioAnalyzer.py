...
class AverageAudioBar(AudioBar):
    ...
    def __init__(self, x, y, rng, color, width=50, min_height=10, max_height=80, min_decibel=-80, max_decibel=0):
...
class RotatedAverageAudioBar(AverageAudioBar):
    ...
    def __init__(self, x, y, rng, color, angle=0, width=50, min_height=10, max_height=80, min_decibel=-80, max_decibel=0):
        super().__init__(x, y, 0, color, width, min_height, max_height, min_decibel, max_decibel)
